...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#2E2F47', padding: 20, paddingBottom: 90 },
  title: { fontSize: 22, color: '#fff', fontWeight: 'bold', marginBottom: 15 },
  chipContainer: { flexDirection: 'row', flexWrap: 'wrap' },
  section: { backgroundColor: '#3B3C59', borderRadius: 12, padding: 12, marginBottom: 20, borderWidth: 1, borderColor: '#4C4D70' },
  ...
  button: { backgroundColor: '#00AEEF', padding: 12, borderRadius: 15, minWidth: '22%', alignItems: 'center', marginBottom: 10 },
  buttonText: { color: '#fff', fontSize: 14, fontWeight: 'bold', textAlign: 'center' },
  card: { backgroundColor: '#1F2133', padding: 15, borderRadius: 15, marginBottom: 15 },
  ...
  historyModal: { width: '85%', backgroundColor: '#3B3C59', borderRadius: 15, padding: 20 },
  explanationModal: { width: '85%', backgroundColor: '#1F2133', borderRadius: 15, padding: 20, maxHeight: '60%' },
  modalTitle: { fontSize: 18, fontWeight: 'bold', color: '#fff', marginBottom: 10 },
  historyCard: { backgroundColor: '#4A4C70', padding: 12, borderRadius: 12, marginBottom: 8 },
})
